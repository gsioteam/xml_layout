...
Register register = Register(() {
  ...
  XmlLayout.registerInline(Matrix4, "translationValues", false, (node, method) {
    return Matrix4.translationValues((method[0]?.toDouble())!,
        (method[1]?.toDouble())!, (method[2]?.toDouble())!);
  });
  ...
  XmlLayout.registerInline(Matrix4, "diagonal3Values", false, (node, method) {
    return Matrix4.diagonal3Values((method[0]?.toDouble())!,
        (method[1]?.toDouble())!, (method[2]?.toDouble())!);
  });
  ...
  XmlLayout.register("AppBar", (node, key) {
    return AppBar(
        ...
        systemOverlayStyle:
            node.s<SystemUiOverlayStyle?>("systemOverlayStyle"));
  });
  ...
  XmlLayout.register("SystemUiOverlayStyle", (node, key) {
    return SystemUiOverlayStyle(
        ...
        statusBarIconBrightness:
            node.s<Brightness?>("statusBarIconBrightness"));
  });
  ...
  XmlLayout.register("Image", (node, key) {
    return Image(
        ...
        frameBuilder:
            node.s<Widget Function(BuildContext, Widget, int?, bool)?>(
                "frameBuilder"),
        loadingBuilder:
  ...
  XmlLayout.registerInline(Offset, "fromDirection", false, (node, method) {
    return Offset.fromDirection(
        (method[0]?.toDouble())!, (method[1]?.toDouble())!);
  });
